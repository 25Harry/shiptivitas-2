...
if (status) {
  ...
  // 1. oldStatus == newStatus & oldPriority == priority, do nothing
  // 2. oldStatus == newStatus & oldPriority != priority, reorder clients with same status
  ...
  // Updating the entire rows on the table
